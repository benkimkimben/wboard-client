...
public abstract class WClientObject implements WObject{
	...
	public WClientObject(OBJTYPE objType) {
		...
		this.lineColor = Constants.BLACK;
		this.faceColor = Constants.WHITE;
		this.lineWidth = Constants.DEFAULT_LINE;
